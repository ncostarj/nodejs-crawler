...
// var pageToVisit = "https://esaj.tjsp.jus.br/cpopg/show.do?processo.codigo=2SZX6F13N0000&processo.foro=100&uuidCaptcha=sajcaptcha_5e753255684f4c85a172eee6ed465b24";
var pageToVisit = "https://esaj.tjsp.jus.br/cpopg/show.do?processo.codigo=2SZX9E9CB0000&processo.foro=100&uuidCaptcha=sajcaptcha_16160c283efe4b4083ad8841002ddde4";
...
function extractProcessPart(body)
{
    ...
    // console.log(teste1);
    // teste2.each(function(){
    //     console.log('teste');
    //     // console.log('teste: ',$(this).html());
    // })
    

    // tabela.css('display','block');

    // console.log('1: ',tabela.html());
